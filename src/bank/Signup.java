        ...
        public void actionPerformed(ActionEvent ae) {
        	...
        	try {
                   ...
                   if (t1.getText().equals("")){
        	        JOptionPane.showMessageDialog(null, "Fill the required Name");}
        	        else if (t2.getText().equals("")){
            	        JOptionPane.showMessageDialog(null, "Fill the YourFather Name");}
            	        else if (t3.getText().equals("")){
                	        JOptionPane.showMessageDialog(null, "Fill the required Address");}
                	        else if (t4.getText().equals("")){
                    	        JOptionPane.showMessageDialog(null, "Fill the required Email Address");}
                    	        else if (t5.getText().equals("")){
                        	        JOptionPane.showMessageDialog(null, "Fill the required City");}
                        	        else if (t6.getText().equals("")){
                            	        JOptionPane.showMessageDialog(null, "Fill the required PinCode");}
                            	        else if (t7.getText().equals("")){
                                	        JOptionPane.showMessageDialog(null, "Fill the required State");}
                                	        else{
        Drivercon c1 = new Drivercon();
        String q1 = "insert into signup values('"+a+"','"+b+"','"+ac+"','"+bc+"','"+cc+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','"+first+"')"; 	        
        	c1.s.executeUpdate(q1);
        	JOptionPane.showMessageDialog(null, "Query Updated and Redirecte to Fill Additional details");
